...
function initializeDropdowns() {
  ...
  countries.forEach(function(country) {
      ...
      optionNationality.textContent = optionResidence.textContent = country.emoji + ' ' + country.name;
...
document.getElementById('nationalityDropdown').addEventListener('change', onCountryChange);
document.getElementById('residenceDropdown').addEventListener('change', onCountryChange);
