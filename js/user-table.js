...
filterElementsLanguage.forEach(element => {
    element.addEventListener('click', () => {
        ...
        if (element.classList.contains('filterall')) {
            ...
            queryData.dataLanguages.length = 0
            filterElementsLanguage.forEach(element => {
                element.classList.contains('selected') ? queryData.dataLanguages.push(element.getAttribute("data-language")) : ''
            })
        }
    })
})
...
filterElementsSport.forEach(element => {
    element.addEventListener('click', () => {
        ...
        if (element.classList.contains('filterall')) {
            ...
            queryData.dataSports.length = 0
            filterElementsSport.forEach(element => {
                element.classList.contains('selected') ? queryData.dataSports.push(element.getAttribute("data-sport")) : ''
            })
        }
    })
})
...
filterElementsAvailability.forEach(element => {
    element.addEventListener('click', () => {
        ...
        if (element.classList.contains('filterall')) {
            ...
            queryData.dataAvailability.length = 0
            filterElementsAvailability.forEach(element => {
                element.classList.contains('selected') ? queryData.dataAvailability.push(element.getAttribute("data-startingtime")) : ''
            })
        }
    })
})
...
filterElementsExperience.forEach(element => {
    element.addEventListener('click', () => {
        ...
        if (element.classList.contains('filterall')) {
            ...
            queryData.dataExperience.length = 0
            filterElementsExperience.forEach(element => {
                element.classList.contains('selected') ? queryData.dataExperience.push(element.getAttribute("data-experience")) : ''
            })
        }
    })
})
